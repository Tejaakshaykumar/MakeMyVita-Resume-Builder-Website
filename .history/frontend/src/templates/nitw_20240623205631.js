    ...
    <div className="resume" id="resume">
      <header className="header">
        ...
        <div className="top-right">
          <p><i class="bi bi-telephone-fill"></i> +91-8347087029</p>
          <p><i class="bi bi-envelope-fill"></i> dhyeygokani2312@gmail.com</p>
          <p><i class="bi bi-envelope-fill"></i> gd21csb0a19@student.nitw.ac.in</p>
