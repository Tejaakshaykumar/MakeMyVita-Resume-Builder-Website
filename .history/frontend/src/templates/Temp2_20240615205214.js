    ...
    <div className="resume">
      ...
      <section className="education">
        ...
        <ul>
          ...
          <li className="edu">
            ...
            <div>
            <p>2019 </p></p> Percentile Rank: 99.99</p>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section className="competitive-programming">
        ...
        <ul>
          ...
          <li>
            <strong>Global Rank 473</strong> in Leetcode Biweekly 100 - 18
            March, 2023
          </li>
          <li>
            <strong>Global Rank 481</strong> in Codeforces Round 878 (Div 3) - 6
            June, 2023
          </li>
        </ul>
      </section>
