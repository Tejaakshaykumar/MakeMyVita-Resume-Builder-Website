...
const Temp1 = ({ personalDetails,imageSrc,educationDetails,skills,courses,experiences,projects,ResumeDetails }) => {
  
  const templateStyle = {
    color: ResumeDetails?ResumeDetails.fontColor :'#000000', // Default to black if undefined
    // fontFamily: ResumeDetails.fontFamily || 'Arial', // Default to Arial if undefined
  };
  const templateColor ={
    // background:ResumeDetails.templateColor
  }
  return (
