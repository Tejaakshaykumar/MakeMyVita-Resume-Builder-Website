...
const Temp1 = ({ personalDetails,imageSrc,educationDetails,skills,courses,experiences,projects }) => {
        ...
        <div className="experience">
          ...
          {projects.map((project, index) => (
            <div key={index}>
              ...
              <p style={{ fontSize: '0.8rem', padding: '0%' }}>{project.projectLink || 'project Link'} / {project.submiDate || 'submission Date'}</p>
              <ul>
