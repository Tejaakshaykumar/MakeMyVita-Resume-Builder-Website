      ...
      <section className="education">
        ...
        <ul>
          {projects.map((project, index) => (
            <li key={index} className="edu">
              <div className="l">
                <strong>{project.companyName || 'companyName'}</strong>
                <p>{project.jobTitle || 'jobTitle'}</p>
                <ul>
                  <li>{project.jobDescription || 'jobDescription'}</li>
                </ul>
              </div>
              <div className="r">
                <p>Submission Date:{project.startDate || 'date'}</p>
              </div>
            </li>
          ))}
        </ul>
