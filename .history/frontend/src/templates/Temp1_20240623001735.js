...
const Temp1 = ({ personalDetails,imageSrc,educationDetails,skills,courses,experiences,projects,ResumeDetails,Resume }) => {
  console.log(ResumeDetails.fontFamily)
  const templateStyle = {
    // color: ResumeDetailsResumeDetails.fontColor: Resume.fontColor,
    // fontFamily: ResumeDetails.fontFamily || Resume.fontFamily,
  };
  const templateColor ={
    // background:ResumeDetails.templateColor ||  Resume.templateColor 
  }
  return (
