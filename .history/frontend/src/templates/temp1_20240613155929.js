...
//           <h2>CONTACT</h2>
//           <p><span className="icon">&#128222;</span>{personalDetails.phone}</p>
...
const Temp1 = ({ personalDetails }) => {
  ...
  return (
    <div className="resume-container" id="resume">
      ...
      <div className="right-panel">
        <h1 style={{ fontSize: '6vh', fontFamily: 'Trebuchet MS' }}>{firstName} {lastName}</h1>
        <h2>{role}</h2>
        <hr />
        <div className="experience">
          <h2>EXPERIENCE</h2>
          ...
          <ul>
            ...
            <li>While it is important to keep descriptions short, adding tion.</li>
            <li>Employers want to know what you accomplished. Make it easy for them to see what you've done by using numbers and percentages.</li>
            <li>For example: Negotoomer annual transportation savings of over $500,000 per year.</li>
          </ul>
          <hr />
          <h2>PROJECTS</h2>
          <h3>PROJECT 1 TITLE HERE</h3>
