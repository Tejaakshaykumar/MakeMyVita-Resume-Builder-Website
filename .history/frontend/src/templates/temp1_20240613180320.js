...
const Temp1 = ({ personalDetails,educationDetails,skills }) => {
        ...
        <div className="experience">
          ...
          {experiences.map((experience, index) => (
            <div key={index}>
              ...
              <p style={{ fontSize: '0.8rem', padding: '0%' }}>{experience.companyName || 'Company / Location / Date Range'}</p>
              <p>{experience.endDate || 'endDate'}</p>
              <ul>
                <li>{experience.jobDes} </li>
              </ul>
            </div>
          ))}
