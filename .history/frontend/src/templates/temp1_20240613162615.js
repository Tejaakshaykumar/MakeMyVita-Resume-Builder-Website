    ...
    <div className="resume-container" id='resume'>
      <div className="left-panel">
        ...
        <div className="contact-info">
          ...
          <p><span className="icon">&#127760;</span>{personalDetails.professionalEmail || personalDetails.personalEmail || 'yourwebsitehere.com'} </p>
        </div>
        <hr />
      ...
      <div className="right-panel">
        <h1 style={{ fontSize: '6vh', fontFamily: 'Trebuchet MS' }}>{personalDetails.firstName && personalDetails.lastName || 'ELIZABETH WILSON'}</h1>
        <h2>{personalDetails.lastName}MARKETING MANAGER</h2>
        <hr />
