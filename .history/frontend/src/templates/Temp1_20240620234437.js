...
const Temp1 = ({ personalDetails,imageSrc,educationDetails,skills,experiences,projects }) => {
    ...
    <div className="resume-container" id='resume'>
      <div className="left-panel">
        <div className="profile-pic">
          <img src={imageSrc || defaultimg } alt="Profile Picture" />
        </div>
        <hr />
        <div className="contact-info">
          <h2>CONTACT</h2>
          <p><span className="icon">&#128222;</span>{personalDetails.phone || resume.personalDetails.phone || '123-456-7890'}</p>
      ...
      <div className="right-panel">
        <h1 style={{ fontSize: '6vh', fontFamily: 'Trebuchet MS' }}>{ (personalDetails.firstName|| resume.personalDetails.firstName || personalDetails.lastName) ? `${personalDetails.firstName} ${personalDetails.lastName}` : 'ELIZABETH WILSON'}</h1>
