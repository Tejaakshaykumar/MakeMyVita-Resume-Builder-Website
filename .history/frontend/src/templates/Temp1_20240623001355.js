...
const Temp1 = ({ personalDetails,imageSrc,educationDetails,skills,courses,experiences,projects,ResumeDetails,Resume }) => {
  ...
  const templateStyle = {
    color: ResumeDetails.fontColor || ResumeDetails.fontColor,
    fontFamily: ResumeDetails.fontFamily || ResumeDetails.fontFamily,
  };
  const templateColor ={
    background:ResumeDetails.templateColor ||  ResumeDetails.templateColor 
  }
  return (
