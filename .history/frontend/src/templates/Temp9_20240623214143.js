...
const Temp9 = ({
  ...
  const templateStyle = {
    color: Resume?ResumeDetails.fontColor: Resume.fontColor,
    fontFamily: Resume? ResumeDetails.fontFamily: Resume.fontFamily,
  };
  const templateColor ={
    background: Resume?ResumeDetails.templateColor : Resume.templateColor 
  }
  return (
