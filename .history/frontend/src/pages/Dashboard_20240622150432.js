    ...
    setTimeout(async () => {
      ...
      if (resumeElement) {
        ...
        if (format === "pdf") {
          ...
          // Add similar checks and sections for skills, experience, and project details
                    ...
                    <div className="button-row">
                      ...
                      <div className="dropdown">
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <button className="dropdown-item" onClick={() => handleDownload(resume._id,resume, "pdf")}>
                            PDF
                          </button>
                          <button className="dropdown-item" onClick={() => handleDownload(resume._id,resume, "png")}>
                            PNG
                          </button>
                          <button className="dropdown-item" onClick={() => handleDownload(resume._id,resume, "jpg")}>
                            JPG
                          </button>
                          <button className="dropdown-item" onClick={() => handleDownload(resume._id,resume, "docx")}>
                            DOCX
                          </button>
                        </div>
                      </div>
