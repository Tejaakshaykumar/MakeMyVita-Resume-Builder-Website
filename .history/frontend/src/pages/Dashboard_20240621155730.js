...
function Dashboard() {
  ...
  if (loading) {
    return <div ><div style={{ width: '100%', height: 0, paddingBottom: '100%', position: 'relative' }}>
    <iframe
    ...
    ></iframe>
    <p>
      <a href="https://giphy.com/gifs/youtube-loading-gif-3o7bu3XilJ5BOiSGic">via GIPHY</a>
    </p>
  </div></div>;
  }
      ...
      <div className="container-fluid1">
        <div className="row">
          <nav className="sidebar">
            <div className="sidebar-sticky">
              <h2 className="sidebar-title" style={{ color: "white" }}>WELCOME</h2>
              <h2 className="sidebar-title" style={{ color: "white" }}>{user?.username}</h2>
              <ul className="nav flex-column">
                <li className="nav-item">
                  <a className="nav-link active" href="#">
                    <i className="bi bi-house-door-fill"></i> Dashboard
