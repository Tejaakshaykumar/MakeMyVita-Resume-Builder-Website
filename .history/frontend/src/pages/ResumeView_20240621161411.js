...
function ResumeView() {
  ...
  const renderTemplate = () => {
    const props = {
      ...
      imageSrc: resume.imageSrc ? `C:\Users\tejaa\OneDrive\files\Desktop\Resume-Project\MakeMyVita\backend\uploads\1718951975917-OIP (1).jpg/${resume.personalDetails.image}` : null, // Update imageSrc
