...
function SignIn() {
  ...
  const handleSignIn = async (event) => {
    ...
    try {
        const response =await fetch('makemyvita.onrender.com/api/auth/login',{
          method :"POST",https://
          headers: {
      ...
      <div className="signin-container">
        <div className="signin-box">
          ...
          <div className="social-login">
            ...
            <button className="btn btn-outline-secondary" onClick={() => handleSocialLogin(provider1)}><i className="fa fa-facebook"></i></button>
            <button className="btn btn-outline-secondary" onClick={() => handleSocialLogin(provider1)}><i className="fa fa-github"></i></button>
          </div>
