                  ...
                  <div className="card bg-light">
                    ...
                    <div className="button-row">
                      ...
                      <div className="dropdown">
                        <button className="btn1 dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          ...
                          <button className="dropdown-item" onClick={() => handleDownload('png')}>PNG</button>
                          <button className="dropdown-item" onClick={() => handleDownload('jpg')}>JPG</button>
                          <button className="dropdown-item" onClick={() => handleDownload('txt')}>TXT</button>
                        </div>
                      </div>
                      <button className="btn1" style={{ backgroundColor: 'red' }}>
                        <i className="bi bi-trash-fill"></i> Delete
