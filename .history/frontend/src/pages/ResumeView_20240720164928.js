...
function ResumeView() {
  ...
  const imageSrc = resume.personalDetails.image ? `https:localhost:5000/${resume.personalDetails.image.replace(/\\/g, '/')}` : null;
  ...
  return (
    <div className="resume-view" id="resume-content" style={{paddingTop:"1in"}}>
      {renderTemplate()}
