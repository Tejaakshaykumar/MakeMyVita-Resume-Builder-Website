    ...
    <div className='signin'>
      <div className="signin-container">
        <div className="signin-box">
          ...
          <div className="social-login">
            <button className="btn btn-outline-secondary" onClick={() => handleOAuthLogin(provider1)}><i className="fa fa-google"></i></button>
            <button className="btn btn-outline-secondary" onClick={() => handleOAuthLogin(provider2)}><i className="fa fa-facebook"></i></button>
            <button className="btn btn-outline-secondary" onClick={() => handleOAuthLogin(provider3)}><i className="fa fa-github"></i></button>
            <button className="btn btn-outline-secondary"><i className="fa fa-linkedin"></i></button>
          </div>
          <span>No Account?</span>
          <button type="submit" className="btn btn-primary btn-block" onClick={handleSignUpClick}>Register now</button>
