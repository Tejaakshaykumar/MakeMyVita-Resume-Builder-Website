          ...
          <div className="timeline-panel">
            ...
            <div className="timeline-body">
              <p>
                ...
                editing, or an image for online use, we've got you covered.<br></br>
                Available Export Formats:<br></br> PDF: Perfect for professional
                presentations and high-quality prints.<br></br> TXT: Simple text file for
                easy editing and customization.<br></br> PNG: High-resolution image for
                use in online portfolios or applications.<br></br> JPG: Widely supported
