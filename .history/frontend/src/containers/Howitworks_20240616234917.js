  ...
  return (
    <div className="container">
      <div className="page-header">
        <h1 id="timeline" style={{textAlign:'center'}}>How to build a resume</h1>
        <p>The resume building process is simple and intuitive:few easy steps
            is all it takes to get from start to finish.Resume writing can be time
        </p>
      </div>
