...
function ResumeEditor() {
  ...
  return (
    <div className="resume-editor">
      ...
      {currentStep === 2 && <Step3EducationDetails goToNextStep={goToNextStep} goToPreviousStep={goToPreviousStep} handleEducationChange={handleEducationChange}/>}
      ...
      {currentStep === 7 && <Step8Finish goToPreviousStep={goToPreviousStep} />}
        ...
        <div className='steps'>
        {currentStep !== 0 && <Temp1 personalDetails={personalDetails} educationDetails={educationDetails} />}
        </div>
      </div>
    </div>
  );
