      ...
      <form>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input type="email" name="professionalEmail" value={professionalEmail} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label>Personal Email:</label>
            <input type="email" name="personalEmail" value={personalEmail} onChange={handleChange} />
          </div>
        </div>

        <div className="form-group">
          <label>Phone:</label>
          <input type="tel" name="phone" value={personalDetailsphone} onChange={handleChange} />
        </div>
