  ...
  return (
    <div className="resume-editor">
      ...
      {currentStep === 7 && <Step8Finish goToPreviousStep={goToPreviousStep} />}
        ...
        <div className='steps'>
        {currentStep !== 0 && <Temp1 personalDetails={personalDetails} imageSrc={imageSrc} educationDetails={educationDetails} skills={skills} experiences={experiences} projects={projects}/>}
        </div>
      </div>
    </div>
  );
