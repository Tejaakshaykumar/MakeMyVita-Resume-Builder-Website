  ...
  return (
    <div className="resume-editor">
      ...
      <div className='editor-steps'>
       <div className='steps'>
       {currentStep === 1 && <Step2PersonalDetails goToNextStep={goToNextStep} goToPreviousStep={goToPreviousStep} handleChange={handleChange} imageSrc={imageSrc} handleImageUpload={hand}/> }
      ...
      {currentStep === 7 && <Step8Finish goToPreviousStep={goToPreviousStep} />}
        ...
        <div className='steps'>
        {currentStep !== 0 && <Temp1 personalDetails={personalDetails} educationDetails={educationDetails} skills={skills} experiences={experiences} projects={projects}/>}
        </div>
      </div>
    </div>
  );
