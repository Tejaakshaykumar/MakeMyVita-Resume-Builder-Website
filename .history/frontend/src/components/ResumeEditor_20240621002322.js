  ...
  return (
    <div className="resume-editor">
      ...
      <div className="editor-steps">
        ...
        <div className="steps">
          {currentStep !== 0 && ResumeDetails.templateNo === 1 && (
            <Temp1
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 2 && (
            <Temp2
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 3 && (
            <Temp3
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 4 && (
            <Temp4
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 5 && (
            <Temp5
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 6 && (
            <Temp6
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 7 && (
            <Temp7
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 8 && (
            <Temp8
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 9 && (
            <Temp9
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 10 && (
            <Temp10
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 11 && (
            <Temp11
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 12 && (
            <Temp12
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 13 && (
            <Temp13
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 14 && (
            <Temp14
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 15 && (
            <Temp15
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
          ...
          {currentStep !== 0 && ResumeDetails.templateNo === 16 && (
            <Temp16
              personalDetails={personalDetails}
              imageSrc={imageSrc}
              educationDetails={educationDetails}
