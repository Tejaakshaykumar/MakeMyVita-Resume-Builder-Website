  ...
  return (
    <div className="resume-editor">
      ...
      {currentStep === 7 && <Step8Finish goToPreviousStep={goToPreviousStep} />}
        ...
        {currentStep !== 0  && ResumeDetails.selectedTemplate===3 && <Temp6 personalDetails={personalDetails} imageSrc={imageSrc} educationDetails={educationDetails} skills={skills} experiences={experiences} projects={projects}/>}
        {currentStep !== 0  && ResumeDetails.selectedTemplate===4 && <Temp6 personalDetails={personalDetails} imageSrc={imageSrc} educationDetails={educationDetails} skills={skills} experiences={experiences} projects={projects}/>}
        {currentStep !== 0  && ResumeDetails.selectedTemplate===5 && <Temp6 personalDetails={personalDetails} imageSrc={imageSrc} educationDetails={educationDetails} skills={skills} experiences={experiences} projects={projects}/>}
        ...
        {currentStep !== 0  && ResumeDetails.selectedTemplate===7 && <Temp6 personalDetails={personalDetails} imageSrc={imageSrc} educationDetails={educationDetails} skills={skills} experiences={experiences} projects={projects}/>}
        {currentStep !== 0  && ResumeDetails.selectedTemplate===8 && <Temp6 personalDetails={personalDetails} imageSrc={imageSrc} educationDetails={educationDetails} skills={skills} experiences={experiences} projects={projects}/>}
