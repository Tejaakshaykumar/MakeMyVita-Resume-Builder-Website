  ...
  return (
    <div className="resume-editor">
      ...
      <div className='editor-steps'>
        ...
        <div className='steps'>
          {currentStep !== 0 && ResumeDetails.templateNo === 1 && <Temp1 personalDetails={personalDetails} imageSrc={imageSrc} educationDetails={educationDetails} skills={skills} courses={courses} experiences={experiences} projects={projects} studentDetails={studentDetails} ResumeDetails={ResumeDetails} />}
