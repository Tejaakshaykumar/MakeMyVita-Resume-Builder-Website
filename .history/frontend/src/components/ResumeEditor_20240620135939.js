  ...
  return (
    <div className="resume-editor">
      ...
      <div className='editor-steps'>
        ...
        <div className='steps'>
          {currentStep !== 0 && ResumeDetails. === 1 && <Temp1 personalDetails={personalDetails} imageSrc={imageSrc} educationDetails={educationDetails} skills={skills} experiences={experiences} projects={projects}/>}
