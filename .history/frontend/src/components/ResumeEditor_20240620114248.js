  ...
  return (
    <div className="resume-editor">
      ...
      {currentStep === 7 && <Step8Finish goToPreviousStep={goToPreviousStep} />}
        ...
        <div className='steps'>
        {currentStep !== 0  && Resume <Temp6 personalDetails={personalDetails} imageSrc={imageSrc} educationDetails={educationDetails} skills={skills} experiences={experiences} projects={projects}/>}
        </div>
      </div>
    </div>
  );
