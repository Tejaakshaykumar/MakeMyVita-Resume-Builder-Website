...
function ResumeEditor() {
  ...
  return (
    <div className="resume-editor">
      ...
      {currentStep === 5 && <Step6Projects goToNextStep={goToNextStep} goToPreviousStep={goToPreviousStep} projects={projects} setProjects={proj} />}
      ...
      {currentStep === 7 && <Step8Finish goToPreviousStep={goToPreviousStep} />}
        ...
        <div className='steps'>
        {currentStep !== 0 && <Temp1 personalDetails={personalDetails} educationDetails={educationDetails} skills={skills} experiences={experiences} />}
        </div>
      </div>
    </div>
  );
