  ...
  return (
    <div className="resume-editor">
      ...
      {currentStep === 7 && <Step8Finish goToPreviousStep={goToPreviousStep} />}
        ...
        {currentStep !== 0  && ResumeDetails.selectedTemplate=== && <Temp6 personalDetails={personalDetails} imageSrc={imageSrc} educationDetails={educationDetails} skills={skills} experiences={experiences} projects={projects}/>}
