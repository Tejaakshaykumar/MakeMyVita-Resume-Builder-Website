    ...
    <div className="step-container1">
      ...
      <div className="form-row">
          <div className="form-group">
            ...
            <input type="text" name="ResumeName" value={personalDetails.firstName} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label>Description:</label>
            <input type="text" name="Description" value={personalDetails.lastName} onChange={handleChange} />
          </div>
        </div>
      <div className="template-list">
        {filteredTemplates.map(template => (
