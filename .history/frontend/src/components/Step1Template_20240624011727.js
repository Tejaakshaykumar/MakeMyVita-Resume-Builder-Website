...
const templates = [
  { id: 1, name: 'Template 1', tags: ['modern', 'professional'], image:'/templates/resume_design_photo01_021_cm--68.jpg' },
  { id: 2, name: 'Template 2', tags: ['student', 'engineering','intern','internship'], image: '/templates/resume.png' },
  { id: 3, name: 'Template 3', tags: ['creative', 'colorful'], image: '/templates/Screenshot_20240530_141030_Chrome.jpgdesigner_resume_template_thumbnail.png' },
  { id: 4, name: 'Template 4', tags: ['modern', 'professional'], image:'/templates/Screenshot_20240530_141030_Chrome.jpg' },
  { id: 5, name: 'Template 5', tags: ['creative', 'colorful'], image: '/templates/minimalist-resume-template.png' },
  { id: 6, name: 'Template 6', tags: ['simple'], image: '/templates/canva-grey-clean-cv-resume-photo-pIsBixsev8I.jpg' },
  ...
  { id: 12, name: 'Template 12', tags: ['creative', 'colorful'], image: '/templates/functional-resume-template.png' },
    ...
    <div className="step-container1">
      ...
      <div className="form-row">
          <div className="form-group">
            ...
            <input type="text" name="name" value={ResumeDetails.name} onChange={handleChange1} required/>
          </div>
          <div className="form-group">
