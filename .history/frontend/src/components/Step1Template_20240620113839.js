    ...
    <div className="step-container1">
      ...
      <div className="form-row">
          <div className="form-group">
            ...
            <input type="text" name="ResumeName" value={ResumeDetails.ResumeName} onChange={handleChange} required/>
          </div>
          <div className="form-group">
            <label>Description:</label>
            <input type="text" name="Description" value={ResumeDetails.Description} onChange={handleChange} r/>
          </div>
        </div>
      <div className="template-list">
        {filteredTemplates.map(template => (
