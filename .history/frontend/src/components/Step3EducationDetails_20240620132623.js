...
const Step3EducationDetails = ({ goToNextStep, goToPreviousStep, educationDetails, setEducationDetails }) => {
    ...
    <div className="step-container">
      ...
      {educationDetails.map((education, index) => (
        <div key={index} className="education-entry">
          ...
          <input type="text" name="school" value={education.instituteName} onChange={(e) => handleEducationChange(index, e)} />

          <label>Degree:</label>
          <input type="text" name="degree" value={education.degree} onChange={(e) => handleEducationChange(index, e)} />

          <label>Field of Study:</label>
          <input type="text" name="fieldOfStudy" value={education.ieldOfStudy} onChange={(e) => handleEducationChange(index, e)} />
