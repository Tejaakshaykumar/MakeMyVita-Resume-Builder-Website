    ...
    <div className="resume-editor">
      ...
      <div className='editor-steps'>
        <div className='steps'>
          ...
          {currentStep === 7 && <Step8Finish readygoToPreviousStep={goToPreviousStep} handleSubmit={handleSubmit} ResumeDetails={ResumeDetails} setResumeDetails={setResumeDetails} />}
        </div>
        <div className='steps'>
