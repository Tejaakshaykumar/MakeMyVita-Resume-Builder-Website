...
const AdditonalDetails = require('../models/StudentDetails')

exports.createResume = async (req, res) => {
  const { name, description, templateNo,fontColor,fontFamily,templateColor, personalDetails, educationDetails, projectDetails, experienceDetails, courseDetails, skillDetails, additionalSections } = req.body;
  try {
...
exports.deleteResume = async (req, res) => {
  ...
  try {
    // Fetch resume details to get associated file paths
