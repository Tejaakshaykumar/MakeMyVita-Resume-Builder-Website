...
exports.createResume = async (req, res) => {
  const { name, description, templateNo,fontColor,fontFamily personalDetails, educationDetails, projectDetails, experienceDetails, courseDetails, skillDetails, additionalSections } = req.body;
  try {
