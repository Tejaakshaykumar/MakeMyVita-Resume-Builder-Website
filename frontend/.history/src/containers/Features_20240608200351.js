...
import './cont.css';
import Images from './mages'; // Adjust the path if necessary

export default function Features() {
  return (
    <section>
      <div style={{ height: "70vh", width: "100%", display: "flex", justifyContent: "flex-start", flexWrap: "wrap", paddingLeft: "8%", paddingRight: "8%" }}>
