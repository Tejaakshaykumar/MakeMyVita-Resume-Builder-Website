    ...
    return (
        <div className="icon-container">
            <div className="icons">
                ...
                <img src={i2mages} alt="Slideshow Line" />
                <img src={i3mags} alt="Themes" />
                <img src={i4mages} alt="Document Search" />
                <img src={i5mages} alt="Folder" />
                <img src={i6mages} alt="Cloud Protection" />
                <img src={i7mages} alt="Challenge Target" />
                <img src={i8mages} alt="Slideshow Line" />
                <img src={i9mages} alt="Themes" />
                <img src={i10mages} alt="Document Search" />
                <img src={i11mages} alt="Folder" />
                <img src={i12mages} alt="Cloud Protection" />
                <img src={i13mages} alt="Themes" />
                <img src={i14mages} alt="Document Search" />
                <img src={i15mages} alt="Folder" />
                <img src={i16mages} alt="Cloud Protection" />
            </div>
        </div>
    );
};
