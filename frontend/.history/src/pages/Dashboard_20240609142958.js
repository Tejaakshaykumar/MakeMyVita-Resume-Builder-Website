      ...
      <div className="row">
        <nav className="col-md-2 d-none d-md-block bg-light sidebar">
          <div className="sidebar-sticky">
            <h2 className="sidebar-title">Simple Admin</h2>
            <ul className="nav flex-column">
              ...
              <li className="nav-item">
                <a className="nav-link" href="#">
                  UI Components <span className="badge badge-new">New</span>
                </a>
                <ul className="nav flex-column ml-3">
                  <li className="nav-item"><a className="nav-link" href="#">Buttons</a></li>
                  <li className="nav-item"><a className="nav-link" href="#">Chart</a></li>
                  <li className="nav-item"><a className="nav-link" href="#">Input</a></li>
                  <li className="nav-item"><a className="nav-link" href="#">Modal</a></li>
                  <li className="nav-item"><a className="nav-link" href="#">Widget</a></li>
                </ul>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#">
