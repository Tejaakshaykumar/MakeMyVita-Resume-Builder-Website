  ...
  return (
    <div className="contact-container">
      ...
      <div className="contact-right">
        <h3>INFO</h3>
        <p><img className='contact-img' src={Image1} alt="location"></img> Hyderabad, Telangana, India</p>
        <p><img className='contact-img' src={Image2} alt="phoneno"></img> +91-8897009748</p>
        <p><img className='contact-img' src={Image3} alt="email"></img> tejaakshaykumar08@gmail.com</p>
