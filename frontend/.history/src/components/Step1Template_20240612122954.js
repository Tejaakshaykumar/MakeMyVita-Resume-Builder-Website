...
import img1 from '../images/1411291.jpg';

const templates = [
  { id: 1, name: 'Template 1', tags: ['modern', 'professional'], image: 'src/images/433-4334735_address-icon-png-address-logo-png-transparent-png.png' },
