...
const templates = [
  ...
  { id: 2, name: 'Template 2', tags: ['creative', 'colorful'], image: '' },
  { id: 3, name: 'Template 3', tags: ['creative', 'colorful'], image: 'template2.png' },
  { id: 4, name: 'Template 4', tags: ['modern', 'professional'], image:'/templates/canva-grey-clean-cv-resume-photo-pIsBixsev8I.jpg' },
  { id: 5, name: 'Template 5', tags: ['creative', 'colorful'], image: 'template2.png' },
  { id: 6, name: 'Template 6', tags: ['creative', 'colorful'], image: 'template2.png' },
